...
$(function(){
	...
	$.ajaxSetup({
		...
		beforeSend: function(XMLHttpRequest) {
			...
			var myMaskImgTag = $('<div id="myMaskDiv" class="myMaskDiv">' + 
									'<img src="/assets/image/lg.circle-slack-loading-icon.gif"></img>'+
								 '</div>');
		    $('body').prepend(myMaskImgTag);
			$("#myMaskDiv").show();

		},
		complete: function(XMLHttpRequest, textStatus) {
			$("#myMaskDiv").hide().remove();
		},
